...
% \usepackage[font={small,rm}]{caption} % to make the captions' font smaller and of rmfamily font
\usepackage[font=small]{caption} % to make the captions' font smaller

% \usepackage{etoolbox}
% \AtBeginEnvironment{tabular}{\rmfamily} % to ensure that the tabular environment uses the rmfamily font

\usepackage[colorlinks=true, linkcolor=black, citecolor=blue, urlcolor=blue]{hyperref} % for hyperlinks
\renewcommand{\bibfont}{\small} % small font in the bibliography

\usepackage{csquotes} % for quotes

\usepackage[printonlyused,nohyperlinks]{acronym} % for acronyms
% ------------------------ Page settings -----------------------------
...
\include{Chapter_2_Theory/theory}
\include{Chapter_3_Computational_details/computational_details}
\include{Chapter_4_Results/results}
\include{Chapter_5_Conclusions/conclusion}
