...
\vspace{-\parskip}
\flushleft
\fontsize{37}{39}\selectfont \textcolor{bluetitle}{A Computational Study of Reactivity and Selectivity in Stearoyl-CoA Desaturase}\\[1.5mm]
...
\vspace{-\parskip}
\flushright
\fontsize{14}{16}\selectfont \textbf{Janko ČIVIĆ}
\end{textblock}
%
...
Co-supervisor: Prof. I. Tuñón\\[-2pt]
\textcolor{blueaff}{University of Valencia}\\[5pt]
...
\include{Chapter_6_Conclusion/conclusion}

\bibliographystyle{naturemag}
\phantomsection
\addcontentsline{toc}{chapter}{Bibliography}
\bibliography{References/iron_introduction.bib}
